...
WANDB_PROJECT="VPPO-Reproduce" \
MAX_PIXELS=1003520 \
MIN_PIXELS=200704 \
swift rlhf --config projects/baselines/VPPO/configs/baseline_DAPO_ViRL39K.yaml \
    --model "Qwen/Qwen2.5-VL-${MODEL_SIZE_NUM}B-Instruct" \
    --output_dir "outputs/baselines/VPPO/0_baseline_DAPO_ViRL39K_Qwen25VL-${MODEL_SIZE_NUM}B" \
    "${EXTRA_ARGS[@]}"
